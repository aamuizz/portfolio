        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-slide-in">
            ...
            <h1 className="font-display text-5xl md:text-7xl font-bold leading-tight">
              ...
              {' '}&amp;{' '}
              <span className="text-gradient-accent">Content Creator</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button size="lg" variant="outline" className="border-border hover:bg-card group">
            ...
            <div className="flex items-center gap-8 pt-4">
              <div>
                <p className="font-display text-3xl font-bold text-gradient-primary">8+</p>
                <p className="text-sm text-muted-foreground">Years Experience</p>
              </div>
              <div className="w-px h-12 bg-border" />
              <div>
                <p className="font-display text-3xl font-bold text-gradient-accent">200+</p>
